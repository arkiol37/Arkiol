            ...
            <div
              ...
              style={{
                ...
                boxShadow:     isCurrent
                  ...
                  : plan.popular
                  ? "0 8px 40px rgba(15,118,110,.12), 0 2px 8px rgba(13,17,23,.08)"
                  : "0 2px 10px rgba(0,0,0,.25)",
              }}
            >
              {plan.popular && (
                <div style={{ position: "absolute", top: -12, left: "50%", transform: "translateX(-50%)", background: "#0F766E", color: "#fff", fontSize: 10, fontWeight: 700, padding: "3px 13px", borderRadius: "var(--radius-full)", letterSpacing: ".07em", textTransform: "uppercase", whiteSpace: "nowrap", boxShadow: "0 2px 10px rgba(15,118,110,.3)" }}>
                  ★ Most Popular
                </div>
              )}
              ...
              {plan.key === "FREE" ? (
                ...
                <PaddleCheckout
                  ...
                  style={{
                    ...
                    boxShadow: plan.popular ? "0 4px 14px rgba(15,118,110,.25)" : "none",
                  }}
                />
              ) : (
            ...
            <thead>
              <tr style={{ background: "var(--bg-elevated)" }}>
                ...
                {(["FREE","CREATOR","PRO","STUDIO"] as const).map((pk, i) => {
                  ...
                  return (
                    <th key={pk} style={{ textAlign: "center", padding: "12px 16px", fontSize: 12, fontWeight: 700, borderBottom: "1px solid var(--border)", background: isCur ? "rgba(15,118,110,.06)" : "transparent", color: isCur ? "var(--accent)" : "var(--text-primary)", borderLeft: i > 0 ? "1px solid var(--border)" : "none" }}>
                      {labels[pk]}
              ...
              {([
                ...
                <tr key={row.label} style={{ borderBottom: "1px solid var(--border)", background: ri % 2 === 0 ? "transparent" : "rgba(255,255,255,0.02)" }}>
                  ...
                  {row.vals.map((v, vi) => {
                    ...
                    const isY = v === "✓", isN = v === "✗";
                    return (
                      <td key={vi} style={{ textAlign: "center", padding: "10px 16px", borderLeft: vi > 0 ? "1px solid var(--border)" : "none", background: isCur ? "rgba(15,118,110,.04)" : "transparent", fontSize: isY || isN ? 15 : 12, fontFamily: isY || isN ? "inherit" : "var(--font-mono)", fontWeight: isCur ? 700 : 400, color: isY ? "var(--success)" : isN ? "var(--border-strong)" : isCur ? "var(--text-primary)" : "var(--text-secondary)" }}>
                        {v}
                      </td>
                    );
                  })}

...
const PLANS = [
  {
    ...
    accentColor: "#8b8ca6",
    color:       "rgba(139,140,166,0.07)",
    borderColor: "rgba(139,140,166,0.16)",
    cta:         "Current plan",
    popular:     false,
  },
  {
  ...
  },
  {
    ...
    perCredit:   "$0.046 per credit",
    description: "For teams who ship campaigns at scale.",
    accentColor: "#7c7ffa",
    color:       "rgba(124,127,250,0.07)",
    borderColor: "rgba(124,127,250,0.40)",
    cta:         "Upgrade to Pro",
    popular:     true,
  },
  {
    ...
    perCredit:   "$0.041 per credit",
    description: "Enterprise-grade AI for large teams.",
    accentColor: "#f59e6b",
    color:       "rgba(245,158,107,0.06)",
    borderColor: "rgba(245,158,107,0.25)",
...
export default function BillingPage() {
  ...
  return (
    <div style={{ padding: "44px 48px", maxWidth: 1100, margin: "0 auto" }}>
      ...
      {!billingReady && (
        <div style={{ background: "#1c1200", border: "1px solid rgba(251,191,36,.3)", borderRadius: 10, padding: "13px 18px", marginBottom: 28, color: "#fbbf24", fontSize: 13 }}>
      ...
      {/* Success */}
      {upgradeSuccess && (
        <div style={{ background: "rgba(52,211,153,.08)", border: "1px solid rgba(52,211,153,.25)", borderRadius: "var(--radius-md)", padding: "13px 20px", marginBottom: 32, color: "#34d399", fontSize: 14, fontWeight: 500, display: "flex", alignItems: "center", gap: 10, animation: "fadeUp .3s ease" }}>
            ...
            <div
              ...
              style={{
                ...
                boxShadow:     isCurrent
                  ...
                  : plan.popular
                  ? "0 8px 40px rgba(124,127,250,.15), 0 2px 12px rgba(0,0,0,.3)"
                  : "0 2px 10px rgba(0,0,0,.25)",
              }}
            >
              {plan.popular && (
                <div style={{ position: "absolute", top: -12, left: "50%", transform: "translateX(-50%)", background: "linear-gradient(90deg,#5558e0,#7c7ffa)", color: "#fff", fontSize: 10, fontWeight: 700, padding: "3px 13px", borderRadius: "var(--radius-full)", letterSpacing: ".07em", textTransform: "uppercase", whiteSpace: "nowrap", boxShadow: "0 2px 10px rgba(124,127,250,.4)" }}>
                  ★ Most Popular
                </div>
              )}
                ...
                <PaddleCheckout
                  ...
                  style={{
                    ...
                    background: plan.popular
                      ? "linear-gradient(135deg,#5558e0,#7c7ffa)"
                      : `${plan.accentColor}16`,
                    color:      plan.popular ? "#fff" : plan.accentColor,
                    fontSize: 12, fontWeight: 700, textAlign: "center",
                    boxShadow: plan.popular ? "0 4px 14px rgba(124,127,250,.3)" : "none",
                  }}
                />
              ) : (
        ...
        <div style={{ animation: "fadeUp .5s ease" }}>
          ...
          <div style={{ marginBottom: 22 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
              ...
              <span style={{ background: "rgba(52,211,153,.1)", border: "1px solid rgba(52,211,153,.25)", color: "#34d399", fontSize: 10, fontWeight: 700, padding: "2px 10px", borderRadius: "var(--radius-full)", letterSpacing: ".06em", textTransform: "uppercase" }}>
          ...
          <div style={{ background: "var(--bg-elevated)", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)", padding: "14px 18px", marginBottom: 20, display: "flex", gap: 24, flexWrap: "wrap" }}>
            ...
            {[
              { label: `${currentPlan} sub`, rate: currentPlan === "CREATOR" ? "$0.050" : currentPlan === "PRO" ? "$0.047" : "$0.042", color: "var(--warning)", note: "your plan" },

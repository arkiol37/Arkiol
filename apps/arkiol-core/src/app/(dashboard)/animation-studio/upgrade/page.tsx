...
export default function AnimationStudioUpgradePage() {
  return (
    <div className="ak-fade-in" style={{ padding: "60px 48px", maxWidth: 720, margin: "0 auto", textAlign: "center" }}>
      ...
      {/* Hero */}
      <div style={{ width: 72, height: 72, borderRadius: "var(--radius-2xl)", background: "rgba(15,118,110,.12)", border: "1px solid rgba(15,118,110,.25)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 34, margin: "0 auto 20px" }}>
        🎬
      </div>

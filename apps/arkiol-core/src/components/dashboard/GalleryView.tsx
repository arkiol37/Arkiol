      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <a href={`/api/assets/${asset.id}/download`} className="ak-btn ak-btn-primary ak-btn-sm" onClick={e => e.stopPropagation()} style={{ fontSize: 12 }}>↓ Export</a>
          </div>
          <button className="ak-btn ak-btn-ghost ak-btn-sm" style={{ fontSize: 11, color: "rgba(255,255,255,0.6)" }} onClick={e => e.stopPropagation()}>
            ✦ Generate Similar
          </button>
        </div>
        {selected && (

      ...
      <div style={{ display: "flex", gap: 6, flexWrap: "wrap", marginBottom: 18 }}>
        {STYLES.map(s => (
          <button key={s} onClick={() => setStyle(s)} style={{
            ...
            border: style === s ? "1px solid rgba(15,118,110,0.4)" : "1px solid rgba(255,255,255,0.08)",
      ...
      <div style={{ display: "flex", gap: 6, marginBottom: 18 }}>
        {[1,2,3].map(n => (
          <button key={n} onClick={() => setVars(n)} style={{
            ...
            border: vars === n ? "1px solid rgba(15,118,110,0.4)" : "1px solid rgba(255,255,255,0.08)",
          }}>{n}</button>
        ))}
      </div>
          ...
          <div style={{ display: "flex", gap: 6, marginBottom: 18 }}>
            {["auto","face","product"].map(m => (
              <button key={m} onClick={() => setYtMode(m)} style={{
                ...
                border: ytMode === m ? "1px solid rgba(15,118,110,0.4)" : "1px solid rgba(255,255,255,0.08)",
              }}>{m}</button>
            ))}
          </div>
        </>

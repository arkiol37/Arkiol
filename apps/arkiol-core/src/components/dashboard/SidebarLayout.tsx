"use client";
// SidebarLayout v16 — dark premium sidebar, enlarged logo, plan-aware Animation Studio routing
...
import { ArkiolMark } from "../ArkiolLogo";
...
const BADGE_STYLES: Record<string, { bg: string; color: string }> = {
  "Paid Plans": { bg: "rgba(245,158,11,0.15)", color: "#f59e0b" },
};
const ELIGIBLE_BADGE = { bg: "rgba(15,118,110,0.15)", color: "#2DD4BF" };
...
export function SidebarLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: "#0d111a", fontFamily: "var(--font-body)" }}>
      {/* ── Sidebar ── */}
      <aside style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: col ? 0 : 11 }}>
            <ArkiolMark px={col ? 30 : 36} animate variant="mono" />
            {!col && (
              <span style={{
        ...
        <div style={{ padding: col ? "10px 8px 4px" : "10px 10px 4px" }}>
          <button
            ...
            onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 6px 20px rgba(15,118,110,0.45)"; }}
            onMouseLeave={e => { e.currentTarget.style.transform = ""; e.currentTarget.style.boxShadow = "0 4px 14px rgba(15,118,110,0.35)"; }}
          >
                ...
                return (
                  ...
                  >
                    <div style={{
                      ...
                      justifyContent: col ? "center" : "flex-start",
                      borderRadius: 8,
                      color: active ? "#2DD4BF" : "rgba(148,163,184,0.75)",
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", padding: "8px" }}>
              ...
              >
                ...
                {!col && (
                  <div style={{ flex: 1, textAlign: "left", minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 10.5, color: "rgba(148,163,184,0.6)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: 4 }}>
              ...
              {menu && !col && (
                <div style={{
                  ...
                  <div style={{ padding: "8px 12px", borderBottom: "1px solid rgba(255,255,255,0.06)", marginBottom: 4 }}>
                    <div style={{ fontSize: 12.5, fontWeight: 600, color: "#cbd5e1" }}>{user.name}</div>
                    <div style={{ fontSize: 11, color: "rgba(148,163,184,0.6)" }}>{user.email}</div>
                  </div>
                  {[{ label: "Settings", href: "/settings" }, { label: "Billing", href: "/billing" }].map(item => (
                    <Link key={item.href} href={item.href} style={{ textDecoration: "none" }}>
                      <div style={{ padding: "7px 12px", fontSize: 13, color: "#94a3b8", borderRadius: 7, cursor: "pointer", transition: "background 120ms ease, color 120ms ease" }}
                  ...
                  <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", marginTop: 4, paddingTop: 4 }}>
                    <button
                      ...
                      style={{ width: "100%", padding: "7px 12px", fontSize: 13, color: "#f87171", background: "none", border: "none", cursor: "pointer", textAlign: "left", borderRadius: 7, fontFamily: "var(--font-body)", transition: "background 120ms ease" }}
          ...
          <button
            ...
            style={{
              ...
              color: "rgba(148,163,184,0.4)", background: "none", border: "none",
      ...
      {/* ── Main content ── */}
      <main style={{ flex: 1, minWidth: 0, overflow: "auto", background: "#0d111a" }}>
        {children}
      </main>
